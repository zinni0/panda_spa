...
class TransactionSchema(BaseModel):
    ...
    :var description: Optional text describing the transaction; defaults to an empty string
    ...
    description: Optional[str] = Field("", description="Optional description of the transaction")
